...
const translations = {    'en': {
        ...
        'auto_delete_notice': 'Note: No documents are kept after translation.',
        ...
        'no_documents_for_translation': 'No documents found for translation. Please upload documents first.',
        'session_error_translation': 'Session error. Please refresh the page and try again.',
        ...
        'translation_completed_with_failures': 'Translation completed with some failures.',
        'translation_failed_completely': 'Translation failed completely.',
        'status_label': 'Status:',
        ...
        'download_translated_documents': 'Download Translated Documents:',        'download_translated_document': 'Download Translated Document',        'delete_all_translated_documents': 'Delete All Translated Documents',
        'delete_confirm_message': 'Are you sure you want to delete all translated documents? This action cannot be undone.',
        'delete': 'Delete',
        'delete_translated_document_tooltip': 'Delete the translated document from the server',
        'delete_individual_confirm_message': 'Are you sure you want to delete "{filename}"? This action cannot be undone.',
        'deleting_individual_document': 'Deleting {filename}...',
        'deleted_individual_document_success': 'Successfully deleted {filename}',
        'delete_individual_document_error': 'Failed to delete {filename}: {error}',
        'deleting_translated_documents': 'Deleting translated documents...',
        'deleted_translated_documents_success': 'Successfully deleted {count} translated documents',
        'delete_translated_documents_error': 'Failed to delete translated documents: {error}',
        'translation_failed': 'Failed',        'upload_failed': 'Upload failed: {error}',
        ...
        'auto_delete_notice': 'Note : Aucun document n\'est conservé après la traduction.',
        ...
        'no_documents_for_translation': 'Aucun document trouvé pour la traduction. Veuillez d\'abord télécharger des documents.',
        'session_error_translation': 'Erreur de session. Veuillez actualiser la page et réessayer.',
        ...
        'translation_completed_with_failures': 'Traduction terminée avec quelques échecs.',
        'translation_failed_completely': 'Traduction échouée complètement.',
        'status_label': 'Statut :',
        ...
        'download_translated_documents': 'Télécharger les Documents Traduits :',        'download_translated_document': 'Télécharger le Document Traduit',        'delete_all_translated_documents': 'Supprimer Tous les Documents Traduits',
        'delete_confirm_message': 'Êtes-vous sûr de vouloir supprimer tous les documents traduits ? Cette action ne peut pas être annulée.',
        'delete': 'Supprimer',
        'delete_translated_document_tooltip': 'Supprimer le document traduit du serveur',
        'delete_individual_confirm_message': 'Êtes-vous sûr de vouloir supprimer "{filename}" ? Cette action ne peut pas être annulée.',
        'deleting_individual_document': 'Suppression de {filename}...',
        'deleted_individual_document_success': '{filename} supprimé avec succès',
        'delete_individual_document_error': 'Échec de la suppression de {filename} : {error}',
        'deleting_translated_documents': 'Suppression des documents traduits...',
        'deleted_translated_documents_success': '{count} documents traduits supprimés avec succès',
        'delete_translated_documents_error': 'Échec de la suppression des documents traduits : {error}',
        'translation_failed': 'Échoué',        'upload_failed': 'Échec du téléchargement : {error}',
